 ...
 * 注册版本转换器
 * 
 * @param endpoint - API端点（如 '/api/config', '/chat-proxy/token'）
 ...
 */
registerTransformer('/chat-proxy/token', 'v1', 'v2', (data: any) => {
  return {
    token: data.token,
 ...
 * v2: 时间戳为毫秒级
 */
registerTransformer('/chat-proxy/poll', 'v1', 'v2', (data: any) => {
